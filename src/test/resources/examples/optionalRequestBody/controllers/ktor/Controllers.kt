package examples.optionalRequestBody.controllers

import examples.optionalRequestBody.models.ItemRequest
import examples.optionalRequestBody.models.ItemResponse
...
public interface ItemsController {
    /**
     * Create an item with an optional request body
     *
     * Route is expected to respond with [examples.optionalRequestBody.models.ItemResponse].
     * Use [examples.optionalRequestBody.controllers.TypedApplicationCall.respondTyped] to send the
     * response.
     *
     * @param itemRequest
    ...
    public suspend fun createItem(
        ...
        call: TypedApplicationCall<ItemResponse>,
    )
    ...
    public companion object {
         ...
         *
         * - POST /items Create an item with an optional request body
         */
        public fun Route.itemsRoutes(controller: ItemsController) {
            post("/items") {
                val itemRequest = call.receiveNullable<ItemRequest>()
                controller.createItem(itemRequest, TypedApplicationCall(call))
            }
        }
