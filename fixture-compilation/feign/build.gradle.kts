dependencies {
    ...
    add("implementation", libs.spring.webmvc)
    add("implementation", libs.spring.security.web)
    add("implementation", libs.feign.core)
    add("implementation", libs.spring.cloud.openfeign.core)
}
